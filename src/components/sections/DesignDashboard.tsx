...
const PIE_COLORS = ['#e85d3b', '#1a1d23', '#5c6570', '#d8dde3']
      ...
      <div className="grid gap-6 lg:grid-cols-[280px_1fr]">
        <aside className="rounded-md border border-line bg-white p-4">
          {mode === 'template' ? (
            ...
            <div className="space-y-5">
              ...
              <div>
                <label className="text-sm font-medium" htmlFor="radius-range">
                  Скругление блоков: {radius}px
                </label>
                <input
                  id="radius-range"
                  type="range"
              ...
              <div>
                ...
                <div className="relative mt-3">
                  <button
                    ...
                    className="w-full rounded border border-dashed border-line px-3 py-2 text-sm hover:border-ink"
                  >
                    + Добавить блок
                  </button>
                  {catalogOpen ? (
                    <div className="absolute left-0 right-0 z-10 mt-1 rounded border border-line bg-white p-1 shadow-sm">
                      {designDashboard.widgetCatalog.map((w) => (
                        <button
                          ...
                          className="block w-full rounded px-2 py-1.5 text-left text-sm hover:bg-surface disabled:opacity-40"
                        >
                          {w.label}
                        </button>
                      ))}
        ...
        >
          <div className="mb-3 flex flex-wrap items-center justify-between gap-2">
            ...
            <span className="rounded border border-line bg-white px-2 py-0.5 text-xs text-muted">
          ...
          {chartsVisible ? (
            <div className="grid gap-4 lg:grid-cols-2">
              {widgets.includes('line') ? (
                <div
                  className="h-52 border bg-white p-2"
                  style={{ borderRadius: theme.radius, borderColor: '#d8dde3' }}
                >
            ...
            <div className="flex h-52 items-center justify-center border border-dashed border-line bg-white text-sm text-muted"
